...
class Pipeline:
    ...
    def with_java_udf(self, udf_name: str, class_path: str) -> Self: ...

    def with_python_udf(self, udf_name: str, func: Callable[..., Any]) -> Self: ...

    def with_ai_model(self, model_name: str, class_name: str, **options: _OptionTypes) -> Self: ...

    def describe(self) -> dict[str, Any]: ...

    def execute(self, *, with_local_cluster: bool = False) -> None: ...
...
class _PipelineIntermediate(Pipeline):
    ...
    ) -> _PipelineIntermediate: ...

    def route(
        self, source_table: str, sink_table: str, *, replace_symbol: str | None = None
    ) -> _PipelineIntermediate: ...
